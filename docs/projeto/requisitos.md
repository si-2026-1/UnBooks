...
| RF05 | O sistema deve gerar recomendações personalizadas de livros. |
| RF06 | O sistema deve permitir busca e filtragem no catálogo da BCE. |
| RF07 | O sistema deve permitir seguidores e feed de atividades publicas. |
| RF08 | O sistema deve exibir livros populares entre os usuários da universidade. |
